...
REM  VERSION : V0 — Rule-Based Full
REM  STATUS  : Deterministic rule-based pipeline — full CRM dataset.
REM ============================================================
...
.\venv\Scripts\python.exe scripts/run_pipe_v6.py --crm-path data/crm_ok_gt_french.csv --output-path data/reports_normalized/results_full.csv --stats-json data/reports_normalized/stats_full.json
