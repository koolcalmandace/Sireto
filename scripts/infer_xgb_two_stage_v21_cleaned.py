...
def _transform_public_sector_input(crm_name: str, crm_city: str = "") -> dict:
    """Version 2.0 Public Sector Input Transformation Pipeline.
    Strips generic administrative prefixes (COMMUNE DE, VILLE DE, MAIRIE DE)
    and extracts distinctive facility tokens for high-precision matching against enseigne1.
    """
    import re
    raw_upper = crm_name.upper().strip()
    
    # 1. Strip generic administrative prefixes
